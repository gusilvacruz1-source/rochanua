...
Os originais ficam em `_fotos-originais/`. O moodboard de referência
não veio para cá: era material de terceiros e já cumpriu o papel dele.
...
assets/
  ...
  fonts/archivo.woff2   variável, peso e largura (88 KB)
  img/*-mt.webp         as chapas reticuladas
  img/logo.webp         o logo da banda
ferramentas/meiatona.py gera chapa a partir de foto
_fotos-originais/       os originais que a banda mandou
.nojekyll               Pages serve os arquivos como estão
```
